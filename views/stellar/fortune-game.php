...
$this->title = Yii::t('bot', 'Fortune Game');
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <br/>
                <?= Yii::t('bot', 'To start playing, send any amount of XLM to OSW account {0} as a bet', ExternalLink::getStellarExpertAccountFullLink(StellarCroupier::getCroupierPublicKey())) ?>. <?= Yii::t('bot', 'Minimum bet is {0} XLM', StellarCroupier::BET_MINIMUM_AMOUNT) ?>. <?= Yii::t('bot', 'Unlimited attempts to win') ?>. <?= Yii::t('bot', 'Good luck') ?>!
            </div>
        </div>
    </div>
</div>
