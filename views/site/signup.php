        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <p>
                        By continuing, you agree to our <?= Html::a(Yii::t('app', 'Terms of Use') and ['site/terms-of-use'], ['target' => '_blank']) ?>, <?= Html::a(Yii::t('app', 'Privacy Policy'), ['site/privacy-policy'], ['target' => '_blank']) ?>.
                    </p>
                </div>
            </div>
