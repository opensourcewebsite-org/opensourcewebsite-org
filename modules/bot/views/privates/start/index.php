...
<br/>
<?= Yii::t('bot', 'My code is open source and is a part of the online community OpenSourceWebsite. You can help the project by participating in its development or supporting it with donations.'); ?><br/>
<br/>
<?= Yii::t('bot', 'Available features (beta testing)'); ?>:<br/>
- <?= Yii::t('bot', 'Jobs'); ?>. <?= Yii::t('bot', 'Automatic job and employee search based on different criteria and locations in automatic mode'); ?>.<br/>
- <?= Yii::t('bot', 'Ads'); ?>. <?= Yii::t('bot', 'Buying, selling, renting, services by different criteria and locations in automatic mode'); ?>.<br/>
<br/>
