...
<?php if ($model->selling_cash_on) : ?>
  • <?= Yii::t('bot', 'Cash') ?><br/>
    • <?= Yii::t('bot', 'Location') ?>: <?= ExternalLink::getOSMFullLink($model->selling_location_lat, $model->selling_location_lon) ?><br/>
<?php if ($model->selling_delivery_radius > 0) : ?>
    • <?= Yii::t('bot', 'Delivery radius') ?>: <?= $model->selling_delivery_radius ?> <?= Yii::t('bot', 'km') ?><br/>
<?php endif; ?>
<?php endif; ?>
...
<?php if ($model->buying_cash_on) : ?>
  • <?= Yii::t('bot', 'Cash') ?><br/>
    • <?= Yii::t('bot', 'Location') ?>: <?= ExternalLink::getOSMFullLink($model->buying_location_lat, $model->buying_location_lon) ?><br/>
<?php if ($model->buying_delivery_radius > 0) : ?>
    • <?= Yii::t('bot', 'Delivery radius') ?>: <?= $model->buying_delivery_radius ?> <?= Yii::t('bot', 'km') ?><br/>
<?php endif; ?>
<?php endif; ?>
