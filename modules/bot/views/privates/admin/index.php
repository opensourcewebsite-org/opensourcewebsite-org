<b><?= \Yii::t('bot', 'Telegram groups and channels') ?></b><br/>
<br/>
...
<br/>
<?= Yii::t('bot', 'Type command /refresh in your group to add your group to the list, or update the list of group administrators') ?>.
