    ...
    'components' => [
        'commandRouteResolver' => [
            ...
            'rules' => [
                ...
                '/admin_filter_chat <groupId:\d+>' => 'chat',
                '/admin_filter_filterchat <groupId:\d+>' => 'filterchat',
                '/admin_filter_change_filter_mode <groupId:\d+>' => 'filterchat/update',
                '/admin_filter_change_filter_on <groupId:\d+>' => 'filterchat/status',
                '/admin_filter_whitelist <groupId:\d+>' => 'whitelist',
                '/admin_filter_blacklist <groupId:\d+>' => 'blacklist',
                '/admin_filter_newphrase <type:\w+> <groupId:\d+>' => 'newphrase/index',
                '/admin_filter_set_newphrase <type:\w+> <groupId:\d+>' => 'newphrase/update',

                '/admin_filter_phrase <phraseId:\d+>' => 'phrase/index',
                '/admin_filter_delete_phrase <phraseId:\d+>' => 'phrase/delete',
                '/admin_filter_change_phrase <phraseId:\d+>' => 'phrase/create',
                '/admin_filter_update_phrase <phraseId:\d+>' => 'phrase/update',
