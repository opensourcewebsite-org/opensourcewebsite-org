 ...
 * @property ApiTestDomain $domain Server domain
...
class ApiTestServer extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['project_id', 'created_at', 'updated_at',  'domain_id'], 'integer'],
            ...
            [['domain_id'], 'exist', 'skipOnError' => true, 'targetClass' => ApiTestDomain::className(), 'targetAttribute' => ['project_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(ApiTestDomain::className(), ['id' => 'domain_id']);
    }
