...
<section class="page-section" id="donate">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <ul>
            <li>Processing with <?= Html::a('Stellar.org', 'https://stellar.org') ?> (<?= Html::a('XLM and all available assets', 'https://stellar.expert/explorer/public/account/GDOB5BAYE25LLEU6CCQCGGJB2ILUEIMA2DTQRGCVHX3XX2ATGMXP5ERH') ?>)</li>
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="sponsors__list">
              <a href="https://www.digitalocean.com/" title="DigitalOcean.com" rel="nofollow noreferrer noopener" target="_blank">
              ...
              <a href="https://moqups.com" title="Moqups.com" rel="nofollow noreferrer noopener" target="_blank">
                <img src="https://landing.moqups.com/img/logo@2x.png" style="background:#1089f2; padding: 10px; height: 53px;" alt="Moqups Logo">
              </a>
            </div>
        </div>
      </div>
