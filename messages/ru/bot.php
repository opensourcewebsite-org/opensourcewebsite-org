...
return [
    ...
    'Keywords are used to find matches with offers from other users' => 'Ключевые слова используются для поиска совпадений с предложениями других пользователей',
    'An ad with keywords sees other offers that contain at least one of the keywords listed' => 'Обьявление с ключевыми словами видит другие предложения в которых есть хотя бы одно из перечисленных ключевых слов',
    'An ad without keywords sees all other offers with and without any keywords' => 'Обьявление без ключевых слов видит все другие предложения с любыми ключевыми словами и без них',
    'bag' => 'сумка',
    ...
    'Choose a currency for hourly rate' => 'Выберите валюту для часовой ставки',
