...
return [
    ...
    'Before joining this group, read the group rules and press {0} to confirm that you are a human' => 'Прежде чем присоединиться к этой группе, прочтите правила группы и нажмите {0}, чтобы подтвердить, что вы человек',
