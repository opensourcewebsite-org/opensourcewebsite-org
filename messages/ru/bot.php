...
return [
    ...
    'Send me new description and I will automaticall change it' => 'Отправьте мне новое описание и я автоматически его изменю',
    'Send me new photo and I will automaticall change it' => 'Отправьте мне новое фото и я автоматически его изменю',
    'Send me new keywords separated by comma, point or new line and I will automaticall change it in your ad' => 'Отправьте мне новые хэштеги через запятую, точку либо новую строку и я автоматически изменю их в вашем объявлении',
    'Send location and I will automatically change it' => 'Отправьте геолокацию и я автоматически её изменю',
    'Send me new price and I will automatically change it' => 'Отправьте мне новую цену и я автоматически её изменю',
    'Send me pickup radius (km) and I will automatically change it' => 'Отправьте радиус самовызова (км) и я автоматически его изменю',
    ...
    'Type keywords separated by comma, point or new line' => 'Введите ключевые слова через запятую, точку либо новую строку',
    ...
    'Type pickup radius, km' => 'Определим радиус самовызова объявлений, км',
    ...
    'Send max price of search ad and I will automatically change it' => 'Введите максимальную цену искомового объявления и я автоматически её изменю',
    'Choose currency of max price of search and I waill automatically change it' => 'Выберите валюту максимальной цены искомового объявления и я автоматически её изменю',
    'No delivery' => 'Нет доставки',
    'Pickup radius' => 'Радиус самовызова',
];
