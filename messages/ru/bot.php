...
return [
    ...
    'to filter messages in your groups' => 'фильтрует сообщения в ваших группах',
    'Change mode' => 'Изменить режим',
    'Change WhiteList' => 'Изменить WhiteList',
    'Change BlackList' => 'Изменить BlackList',
    'List of phrases for the Whitelist' => 'Список фраз для Whitelist',
    ...
    'Messages from the bot and administrators will not be deleted' => 'Сообщения бота и администраторов не будет удалены',
    'List of phrases for the Blacklist' => 'Список фраз для Blacklist',
    ...
    'to automatic delete joining and leaving system messages in your groups' => 'автоматически удаляет системные сообщения о добавлении и отключении пользователей в ваших группах',
    'Next' => 'Далее',
    'Chats' => 'Чаты',
