...
return [
    ...
    'As a reply to another message' => 'В виде ответа на другое сообщение',
    ...
    'Edit Messages of Others' => 'Изменение чужих сообщений',
    'Delete Messages of Others' => 'Удаление чужих сообщений',
    'Delete Messages' => 'Удаление сообщений',
    'Ban Users' => 'Блокировка пользователей',
    'Add Members' => 'Добавление участников',
    ...
    'Limit of messages per premium member per day' => 'Лимит сообщений на одного премиум участника в день',
    'Limit of messages' => 'Лимит сообщений',
    'Limit of messages (membership)' => 'Лимит сообщений (членство)',
    'today' => 'сегодня',
    ...
    'Send a maximum number of messages per premium member per day' => 'Отправьте максимальное количество сообщений на одного премиум участника в день',
    ...
    'Change' => 'Изменить',
    'Remove' => 'Удалить',
    'without replies or tags' => 'без ответов или тегов',
    ...
    'Captcha' => 'Капча',
    'sends a private message with a captcha to new members who have applied to join the group' => 'отправляет личное сообщение с капчей новым участникам, подавшим заявку на вступление в группу',
    'Works only when the «Approve New Members» mode is active' => 'Работает только тогда, когда активен режим «Approve New Members»',
    'Ignores bots' => 'Игнорирует ботов',
    'Link to Rules' => 'Ссылка на правила',
    'RULES' => 'ПРАВИЛА',
    'Send a link to rules' => 'Отправьте ссылку на правила',
    ...
    'To join this group, read the group rules and press {0}' => 'Чтобы присоединиться к этой группе, прочтите правила группы и нажмите {0}',
    ...
    'Send a message for the captcha' => 'Отправьте сообщение для капчи',
    ...
    'The message was posted without any tags' => 'Сообщение было опубликовано без тегов',
    'Use any # tag in a new message to start a new discussion, or post a message as a reply to another member\'s message' => 'Используйте любой тег с # в новом сообщении чтобы начать новое обсуждение или опубликуйте сообщение в виде ответа на сообщение другого участника',
    ...
    'show member information' => 'показать информацию об участнике',
    'show Group ID and Topic ID' => 'показать ID группы и ID топика',
    'show current member ID' => 'показать ID текущего участника',
    'show current member Rank' => 'показать ранг текущего участника',
