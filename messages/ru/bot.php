...
return [
    ...
    'Send me pickup radius (km) and I will automatically change it' => 'Отправьте радиус самовывоза (км) и я автоматически его изменю',
    ...
    'Type pickup radius, km' => 'Определим радиус самовывоза объявлений, км',
