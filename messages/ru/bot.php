...
return [
    ...
    'Send me new keywords and I will automaticall change it in your ad' => 'Отправьте мне новый хэштеги и я автоматически изменю их в вашем объявлении',
    ...
    'Error' => 'Ошибка',
    'Type keywords starting with #' => 'Введите хэштеги начиная с символа #',
    ...
    'Type keywords' => 'Введите ключевые слова',
    'Type some hashtags by keywords, using them I will find matches and show ads' => 'Запишите по ключевым словам несколько хэштегов, по которым я буду искать совпадения и показывать объявления',
    'bag' => 'сумка',
