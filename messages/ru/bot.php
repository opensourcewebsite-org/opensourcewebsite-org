...
return [
    ...
    'Send a reply <code>+</code> to a message of any member, excludes bots, to leave your like for a member\'s message and increase member\'s reputation' => 'Отправьте ответ <code>+</code> на сообщение любого участника, исключая ботов, чтобы оставить ваш лайк для сообщения участника и повысить репутацию участника',
    'Send a reply <code>-</code> to a message of any member, excludes bots, to leave your dislike for a member\'s message and decrease member\'s reputation' => 'Отправьте ответ <code>-</code> на сообщение любого участника, исключая ботов, чтобы оставить ваш дизлайк для сообщения участника и понизить репутацию участника',
    'Show a list of members with likes' => 'Показать список участников с лайками',
    'Send a reply <code>voteban</code> to a message of any member, excludes administrators, to vote to ban or kick a member' => 'Отправьте ответ <code>voteban</code> на сообщение любого участника, исключая администраторов, чтобы проголосовать о том чтобы забанить или кикнуть участника',
